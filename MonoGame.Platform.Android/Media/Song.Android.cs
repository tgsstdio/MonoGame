...
namespace MonoGame.Platform.Android.Media
{

    public sealed partial class AndroidSong : IEquatable<Song>, IDisposable
    {
...
//        }
        ...
        internal Song(IAlbum album, IArtist artist, IGenre genre, string name, TimeSpan duration, Android.Net.Uri assetUri)
        {
            this.album = album;
            this.artist = artist;
            this.genre = genre;
