...
//		}
		...
		protected IMouseListener mMouse;
		protected BaseGamePlatform(IGraphicsDeviceManager graphics, IPlatformActivator activator, IMouseListener mouse)
        {
			Graphics = graphics;
			Activator = activator;
			mMouse = mouse;
