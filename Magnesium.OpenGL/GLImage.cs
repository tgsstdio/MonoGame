...
namespace Magnesium.OpenGL
{
	public class GLImage : IMgImage
	{
		...
		public GLImage (int textureId, MgImageType imageType, MgFormat format, SizedInternalFormat internalFormat, int width, int height, int depth, int levels, int arrayLayers)
		{
