...
namespace MonoGame.Graphics.AZDO
{
		...
		where TData : struct
	{
		...
		public IShaderStorageBuffer<TData> Buffer { get; private set; }

		public ShaderStorageBufferBinder (IList<TInfo> sources, IShaderStorageBuffer<TData> buffer, Func<TInfo, TData> generator)
		{
