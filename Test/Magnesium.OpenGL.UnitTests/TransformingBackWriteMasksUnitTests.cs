...
namespace Magnesium.OpenGL.UnitTests
{
	...
	public class TransformingBackWriteMasksUnitTests
	{
			...
			repo.GraphicsPipelines.Add (new MockGLGraphicsPipeline 
				{
					...
					DynamicsStates = 0,
					Back = new GLGraphicsPipelineStencilMasks{ WriteMask = DEFAULT_VALUE},
		...
		public void OverrideAllowed ()
		{
			...
			// USE OVERRIDE 
			var command_0 = new GLCmdDrawCommand{ Pipeline = 0, BackWriteMask = 0, Draw = new GLCmdInternalDraw{ }  };
			...
			var command_1 = new GLCmdDrawCommand{ Pipeline = 0, BackWriteMask = null, Draw = new GLCmdInternalDraw{ }  };
			...
			var command_2 = new GLCmdDrawCommand{ Pipeline = 0, BackWriteMask = null, Draw = new GLCmdInternalDraw{ }  };
