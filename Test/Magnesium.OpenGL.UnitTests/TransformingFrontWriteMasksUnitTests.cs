...
namespace Magnesium.OpenGL.UnitTests
{
	...
	public class TransformingFrontWriteMasksUnitTests
	{
		...
		public void NoneFound ()
		{
			...
			var command = new GLCmdDrawCommand{ FrontWriteMask = null };
		...
		public void NoPipeline ()
		{
			...
			var command = new GLCmdDrawCommand{ Pipeline = null, FrontWriteMask = 0 };
		...
		public void NoOverrideAllowed ()
		{
			...
			var command = new GLCmdDrawCommand{ Pipeline = 0, FrontWriteMask = 0 };
		...
		public void OverrideAllowed ()
		{
			...
			// USE OVERRIDE 
			var command_0 = new GLCmdDrawCommand{ Pipeline = 0, FrontWriteMask = 0 };
			...
			var command_1 = new GLCmdDrawCommand{ Pipeline = 0, FrontWriteMask = null };
			...
			var command_2 = new GLCmdDrawCommand{ Pipeline = 0, FrontWriteMask = null };
