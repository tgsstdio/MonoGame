...
namespace Magnesium.OpenGL.UnitTests
{
	...
	public class TransformingDepthBiasUnitTests
	{
		...
		public void NoneFound ()
		{
			...
			var command = new GLCmdDrawCommand{ DepthBias = null };
		...
		public void NoPipeline ()
		{
			...
			var command = new GLCmdDrawCommand{ Pipeline = null, DepthBias = 0 };
		...
		public void NoOverrideAllowed ()
		{
			...
			var command = new GLCmdDrawCommand{ Pipeline = 0, DepthBias = 0 };
		...
		public void OverrideAllowed ()
		{
			...
			// USE OVERRIDE 
			var command_0 = new GLCmdDrawCommand{ Pipeline = 0, DepthBias = 0 };
			...
			var command_1 = new GLCmdDrawCommand{ Pipeline = 0, DepthBias = null };
			...
			var command_2 = new GLCmdDrawCommand{ Pipeline = 0, DepthBias = null };
