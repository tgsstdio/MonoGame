...
namespace BirdNest.MonoGame.Graphics.Ktx
{
	public class SparseTextureAtlas : ITextureAtlas
	{
		...
		static Tuple<int, int, int, int, int, int> ExtractImageTypeKey (GLImageType info)
		{
		...
		static Tuple<Tuple<int, int, int, int, int, int>,Tuple<int, int, int>, Tuple<int, int, int, int>> ExtractKey(TextureCatalog info, GLImageType typeKey, ImageDimensions dims)
		{
		...
		public ITextureChapter Add (TextureCatalog catalog, GLImageType imageType, TextureTarget glTarget, ImageDimensions dims)
		{
